...
@objid ("9b142c74-8d61-448b-b9be-6ffbe5c1f3da")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("73f4d646-7832-4300-8409-efad2696f68d")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_code_smells"));
            Measure m = struts.getMeasure("new_code_smells");
