...
@objid ("49fd7c1e-f17f-4806-a800-363d112a5f8e")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("f2518103-d18d-45b1-be86-a0d1d3dfb11b")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "violations"));
            Measure m = struts.getMeasure("violations");
