...
@objid ("f9d6918d-2ddf-41cf-b13e-4ad3a4c79495")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("41510e47-422a-4dc9-8a84-9e009f102512")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "comment_lines"));
            Measure m = struts.getMeasure("comment_lines");
