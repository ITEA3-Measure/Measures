...
@objid ("e4601bd4-1288-4263-8aab-549857856cdf")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("c666a073-18cd-46f3-b74a-e19ed8ad43a4")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_branch_coverage"));
            Measure m = struts.getMeasure("new_branch_coverage");
