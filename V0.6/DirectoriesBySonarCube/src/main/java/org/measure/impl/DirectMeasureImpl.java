...
@objid ("80bf0caa-1980-4c17-acea-6adcffb68f7a")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("c00edb16-d7fa-492b-ab6b-1de9b1a9e2aa")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "directories"));
            Measure m = struts.getMeasure("directories");
