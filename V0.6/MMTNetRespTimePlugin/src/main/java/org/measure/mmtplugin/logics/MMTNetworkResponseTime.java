...
public class MMTNetworkResponseTime extends MMTLogic {
    ...
    public MMTMeasurement computeMetrics(MongoCollection collection) {
            ...
            */
                    ...
                    Arrays.asList(
                            Aggregates.match(
                                    Filters.and(
                                            ...
                                            Filters.gt("26", 0) // Ignore reports whose RTT is 0
                                    )
                            ),
                            Aggregates.group("$0", Accumulators.avg("avgRTT", "$26"))
                    )
            ).iterator();
            ...
            while(cursorb.hasNext()){
                ...
                avgRTT = doc.getDouble("avgRTT").intValue();
            }
            
            measurement.addValue("averageNetworkRTT", avgRTT);
            
            measurement.setValue(avgRTT);
