...
@objid ("0c4570ec-a4fe-40cf-ac2e-4fb96408b973")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("ef71e0ca-4b77-419a-a295-fe8b35e7e789")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_line_coverage"));
            Measure m = struts.getMeasure("new_line_coverage");
