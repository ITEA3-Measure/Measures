...
@objid ("723a3295-c96a-4c29-90c3-3afa8f14d192")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("588a21f8-85ed-46ab-a8c3-6b42759bcab6")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "test_success_density"));
            Measure m = struts.getMeasure("test_success_density");
