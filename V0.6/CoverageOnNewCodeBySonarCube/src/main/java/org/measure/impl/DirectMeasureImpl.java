...
@objid ("ae3d8e86-93b2-4893-98b4-79b86229a3ed")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("bc7c953f-7492-4934-8539-6a234d61aa30")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_coverage"));
            Measure m = struts.getMeasure("new_coverage");
