...
@objid ("0d20ae1a-d7f1-4cae-a1a2-3cc46ceada21")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("e7fb868c-32d7-4744-b715-f00da1330d59")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "line_coverage"));
            Measure m = struts.getMeasure("line_coverage");
