...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public static final String SCOPE_QUERY_NAME = "queryName";
    ...
    public DirectMeasureImpl() {
        ...
        preload("DataBio_Avg_ImportanceScore.eol");
        preload("DataBio_NumberOfBusinessElements.eol");
        preload("DataBio_Max_ImportanceScore.eol");
        preload("DataBio_NumberOfTechnologyElements.eol");
        preload("DataBio_Median_ImportanceScore.eol");
        preload("DataBio_Quartile1_ImportanceScore.eol");
        preload("DataBio_Min_ImportanceScore.eol");
        preload("DataBio_Quartile3_ImportanceScore.eol");
        preload("DataBio_NumberOfApplicationElements.eol");
	}
    ...
    protected void initProperties() {
        ...
        this.query = loadedQueries.get(getProperty(SCOPE_QUERY_NAME));
    }
