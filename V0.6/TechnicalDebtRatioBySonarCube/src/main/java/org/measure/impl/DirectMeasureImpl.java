...
@objid ("cc35b675-7143-4cb4-9e29-9e3cf3ec0dbd")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("cadb843e-b6f7-410b-95b5-4e466e5cecd3")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "sqale_debt_ratio"));
            Measure m = struts.getMeasure("sqale_debt_ratio");
