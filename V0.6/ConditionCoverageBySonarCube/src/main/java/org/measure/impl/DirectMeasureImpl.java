...
@objid ("28af8c28-0689-4f7e-8e62-795f7549aa29")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("b282ed6f-2573-4efb-95ce-b60abb4a824a")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "branch_coverage"));
            Measure m = struts.getMeasure("branch_coverage");
