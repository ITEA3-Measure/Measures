...
@objid ("a02a34f4-306c-472c-b269-c38e26a53f45")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("a7db897a-5e40-4dc4-bcde-f412cce76f50")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "comment_lines_density"));
            Measure m = struts.getMeasure("comment_lines_density");
