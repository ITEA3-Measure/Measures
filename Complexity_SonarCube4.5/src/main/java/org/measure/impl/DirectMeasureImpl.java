...
@objid ("c70bb0df-84f5-4eb1-8eb0-21bf5f6178cc")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("e9d5d732-21bc-4276-9b32-b383d9dbe0ab")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "complexity"));
            Measure m = struts.getMeasure("complexity");
