...
@objid ("8f043acd-120e-494d-9a54-279a0a08edc2")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("aaf78be7-a7a2-476c-aaee-a099b30d349a")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "uncovered_conditions"));
            Measure m = struts.getMeasure("uncovered_conditions");
