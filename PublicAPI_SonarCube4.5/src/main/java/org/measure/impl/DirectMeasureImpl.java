...
@objid ("06210130-bad0-47a0-8765-ede51fa8aa72")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("3369f545-df31-47f5-84bb-9c3da5ee8e3c")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "public_api"));
            Measure m = struts.getMeasure("public_api");
