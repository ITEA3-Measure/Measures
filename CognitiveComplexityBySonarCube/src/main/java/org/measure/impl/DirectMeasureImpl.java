...
@objid ("ba5c351e-e2f7-44c3-add9-d2750e5e60c1")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("cbb22be0-a08b-4724-9c26-ade18a4eaa09")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "cognitive_complexity"));
            Measure m = struts.getMeasure("cognitive_complexity");
