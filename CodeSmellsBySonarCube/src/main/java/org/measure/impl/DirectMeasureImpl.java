...
@objid ("cd10389a-8a66-4841-ac4b-042f4ec0575b")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("14f9da42-6526-4176-a3f4-254b22fcba08")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "code_smells"));
            Measure m = struts.getMeasure("code_smells");
