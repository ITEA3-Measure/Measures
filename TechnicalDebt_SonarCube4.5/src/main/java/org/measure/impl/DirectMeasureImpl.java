...
@objid ("d31ffc67-6bda-4ca4-967b-fed734e79979")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("a0a9040c-c35d-405e-8753-6d462a29ec5f")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "sqale_index"));
            Measure m = struts.getMeasure("sqale_index");
