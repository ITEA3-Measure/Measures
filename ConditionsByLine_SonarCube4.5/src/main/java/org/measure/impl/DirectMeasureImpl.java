...
@objid ("53cca107-4f1c-4c63-96b4-6ecb3bf8367c")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("77d37736-43b1-4f23-8d59-81779271c366")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "conditions_by_line"));
            Measure m = struts.getMeasure("conditions_by_line");
