...
@objid ("fbf63985-75c9-4218-aa20-bf7f552b2d14")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("30537f32-9eb5-424e-b287-502e4dda9a77")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "quality_gate_details"));
            Measure m = struts.getMeasure("quality_gate_details");
