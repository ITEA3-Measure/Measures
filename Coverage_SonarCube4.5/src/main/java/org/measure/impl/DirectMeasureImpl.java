...
@objid ("5bfc9727-9e73-4e0b-a0b9-5bff563fbf3f")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("78dd8b42-0d73-4eff-8f3d-d142f55649a0")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "coverage"));
            Measure m = struts.getMeasure("coverage");
