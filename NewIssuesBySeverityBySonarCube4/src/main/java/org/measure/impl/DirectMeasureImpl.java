...
@objid ("ce8cb021-ee81-43a2-a742-cab160d394f9")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("9fe5247a-3e4d-4e23-9d3f-d1bdb0020a4b")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_"+severity+"_violations"));
            Measure m = struts.getMeasure("new_"+severity+"_violations");
