...
@objid ("cba97334-da0e-4d2c-8c3d-a4766b8a9229")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("8190b0f5-95f4-43ae-8b32-7c077e9cf951")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_technical_debt"));
            Measure m = struts.getMeasure("new_technical_debt");
