...
@objid ("9f2ee2d2-9583-4633-be45-b5d6aa2aee02")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("ecd4c4f6-bcc6-4a86-b26d-8208df6ef9f3")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "test_execution_time"));
            Measure m = struts.getMeasure("test_execution_time");
