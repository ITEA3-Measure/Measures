package org.measure.sonarqube.vulnerabilities;
...
import org.measure.sonarqube.vulnerabilities.data.RTHistory;
import org.measure.sonarqube.vulnerabilities.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=vulnerabilities&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
