package org.measure.sonarqube.blockerviolations;
...
import org.measure.sonarqube.blockerviolations.data.RTHistory;
import org.measure.sonarqube.blockerviolations.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=blocker_violations&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
