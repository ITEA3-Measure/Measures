package org.measure.sonarqube.majorviolations;
...
import org.measure.sonarqube.majorviolations.data.RTHistory;
import org.measure.sonarqube.majorviolations.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=major_violations&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
