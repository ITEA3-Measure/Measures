package org.measure.sonarqube.uncoveredlines;
...
import org.measure.sonarqube.uncoveredlines.data.RTHistory;
import org.measure.sonarqube.uncoveredlines.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=uncovered_lines&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
