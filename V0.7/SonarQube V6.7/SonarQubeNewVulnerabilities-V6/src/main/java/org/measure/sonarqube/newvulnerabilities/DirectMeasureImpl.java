package org.measure.sonarqube.newvulnerabilities;
...
import org.measure.sonarqube.newvulnerabilities.data.RTHistory;
import org.measure.sonarqube.newvulnerabilities.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_vulnerabilities&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
