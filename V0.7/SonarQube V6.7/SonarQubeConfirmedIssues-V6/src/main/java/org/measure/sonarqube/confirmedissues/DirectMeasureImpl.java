package org.measure.sonarqube.confirmedissues;
...
import org.measure.sonarqube.confirmedissues.data.RTHistory;
import org.measure.sonarqube.confirmedissues.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=confirmed_issues&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
