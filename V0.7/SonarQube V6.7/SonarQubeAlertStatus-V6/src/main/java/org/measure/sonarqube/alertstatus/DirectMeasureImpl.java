package org.measure.sonarqube.alertstatus;
...
import org.measure.sonarqube.alertstatus.data.RTHistory;
import org.measure.sonarqube.alertstatus.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=alert_status&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
