package org.measure.sonarqube.coveragelinehitsdata;
...
import org.measure.sonarqube.coveragelinehitsdata.data.RTHistory;
import org.measure.sonarqube.coveragelinehitsdata.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=coverage_line_hits_data&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
