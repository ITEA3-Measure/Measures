package org.measure.sonarqube.newsecurityremediationeffort;
...
import org.measure.sonarqube.newsecurityremediationeffort.data.RTHistory;
import org.measure.sonarqube.newsecurityremediationeffort.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_security_remediation_effort&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
