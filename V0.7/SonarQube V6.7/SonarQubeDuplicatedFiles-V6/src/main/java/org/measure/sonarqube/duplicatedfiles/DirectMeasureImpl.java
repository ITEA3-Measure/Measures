package org.measure.sonarqube.duplicatedfiles;
...
import org.measure.sonarqube.duplicatedfiles.data.RTHistory;
import org.measure.sonarqube.duplicatedfiles.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=duplicated_files&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
