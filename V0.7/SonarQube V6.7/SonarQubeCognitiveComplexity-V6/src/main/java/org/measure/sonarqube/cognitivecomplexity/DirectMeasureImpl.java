package org.measure.sonarqube.cognitivecomplexity;
...
import org.measure.sonarqube.cognitivecomplexity.data.RTHistory;
import org.measure.sonarqube.cognitivecomplexity.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=cognitive_complexity&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
