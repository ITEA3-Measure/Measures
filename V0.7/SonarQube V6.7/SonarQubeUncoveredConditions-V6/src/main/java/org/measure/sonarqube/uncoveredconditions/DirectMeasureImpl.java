package org.measure.sonarqube.uncoveredconditions;
...
import org.measure.sonarqube.uncoveredconditions.data.RTHistory;
import org.measure.sonarqube.uncoveredconditions.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=uncovered_conditions&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
