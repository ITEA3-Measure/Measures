package org.measure.sonarqube.reliabilityremediationeffort;
...
import org.measure.sonarqube.reliabilityremediationeffort.data.RTHistory;
import org.measure.sonarqube.reliabilityremediationeffort.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=reliability_remediation_effort&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
