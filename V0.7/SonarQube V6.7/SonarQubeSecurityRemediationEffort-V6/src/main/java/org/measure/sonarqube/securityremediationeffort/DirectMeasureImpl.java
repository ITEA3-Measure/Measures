package org.measure.sonarqube.securityremediationeffort;
...
import org.measure.sonarqube.securityremediationeffort.data.RTHistory;
import org.measure.sonarqube.securityremediationeffort.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=security_remediation_effort&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
