package org.measure.sonarqube.coveredconditionsbyline;
...
import org.measure.sonarqube.coveredconditionsbyline.data.RTHistory;
import org.measure.sonarqube.coveredconditionsbyline.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=covered_conditions_by_line&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
