package org.measure.sonarqube.newsqaledebtratio;
...
import org.measure.sonarqube.newsqaledebtratio.data.RTHistory;
import org.measure.sonarqube.newsqaledebtratio.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_sqale_debt_ratio&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
