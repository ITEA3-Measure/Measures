package org.measure.sonarqube.newuncoveredlines;
...
import org.measure.sonarqube.newuncoveredlines.data.RTHistory;
import org.measure.sonarqube.newuncoveredlines.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_uncovered_lines&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
