package org.measure.sonarqube.reliabilityrating;
...
import org.measure.sonarqube.reliabilityrating.data.RTHistory;
import org.measure.sonarqube.reliabilityrating.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=reliability_rating&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
