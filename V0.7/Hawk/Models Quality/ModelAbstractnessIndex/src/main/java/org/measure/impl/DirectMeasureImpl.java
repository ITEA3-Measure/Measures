...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    protected void initProperties() {
        ...
        this.query = "var cls =  Class.all;" + "var itrf = Interface.all;" + "if(cls.size + itrf.size > 0){" + "return (cls.select(c|c.IsAbstract).size + itrf.select(c|c.IsAbstract).size).asDouble()  /( cls.size + itrf.size).asDouble() * 100.0;" + "}" + "return 0.0;";
    }
