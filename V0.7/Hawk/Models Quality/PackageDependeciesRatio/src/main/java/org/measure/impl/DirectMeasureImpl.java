...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    protected void initProperties() {
        ...
        this.query = "var cls  = Package.all;" + "if(cls.notEmpty()){" + "var nbDep = 0;" + "for(dp in Dependency.all){" + "if(dp.hawkParent.isTypeOf(Class)){" + "nbDep = nbDep+1;" + "}" + "}" + "return nbDep.asDouble() / cls.size.asDouble();" + "}" + "return 0.0;";
    }
