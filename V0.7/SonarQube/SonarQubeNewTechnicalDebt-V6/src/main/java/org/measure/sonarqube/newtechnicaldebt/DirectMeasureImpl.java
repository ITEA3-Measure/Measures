package org.measure.sonarqube.newtechnicaldebt;
...
import org.measure.sonarqube.newtechnicaldebt.data.RTHistory;
import org.measure.sonarqube.newtechnicaldebt.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_technical_debt&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
