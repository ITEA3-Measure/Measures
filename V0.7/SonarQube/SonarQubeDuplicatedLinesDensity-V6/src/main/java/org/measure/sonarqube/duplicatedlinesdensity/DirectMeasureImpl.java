package org.measure.sonarqube.duplicatedlinesdensity;
...
import org.measure.sonarqube.duplicatedlinesdensity.data.RTHistory;
import org.measure.sonarqube.duplicatedlinesdensity.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=duplicated_lines_density&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
