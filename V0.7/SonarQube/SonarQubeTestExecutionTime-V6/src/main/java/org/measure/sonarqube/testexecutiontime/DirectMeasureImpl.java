package org.measure.sonarqube.testexecutiontime;
...
import org.measure.sonarqube.testexecutiontime.data.RTHistory;
import org.measure.sonarqube.testexecutiontime.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=test_execution_time&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
