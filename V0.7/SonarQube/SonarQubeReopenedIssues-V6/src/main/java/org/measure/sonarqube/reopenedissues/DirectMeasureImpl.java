package org.measure.sonarqube.reopenedissues;
...
import org.measure.sonarqube.reopenedissues.data.RTHistory;
import org.measure.sonarqube.reopenedissues.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=reopened_issues&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
