package org.measure.sonarqube.commentlinesdensity;
...
import org.measure.sonarqube.commentlinesdensity.data.RTHistory;
import org.measure.sonarqube.commentlinesdensity.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=comment_lines_density&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
