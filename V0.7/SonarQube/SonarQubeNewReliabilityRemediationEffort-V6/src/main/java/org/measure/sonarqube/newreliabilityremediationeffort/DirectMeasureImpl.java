package org.measure.sonarqube.newreliabilityremediationeffort;
...
import org.measure.sonarqube.newreliabilityremediationeffort.data.RTHistory;
import org.measure.sonarqube.newreliabilityremediationeffort.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_reliability_remediation_effort&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
