package org.measure.sonarqube.newcriticalviolations;
...
import org.measure.sonarqube.newcriticalviolations.data.RTHistory;
import org.measure.sonarqube.newcriticalviolations.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_critical_violations&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
