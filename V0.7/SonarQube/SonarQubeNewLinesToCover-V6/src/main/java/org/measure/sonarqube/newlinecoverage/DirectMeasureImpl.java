package org.measure.sonarqube.newlinecoverage;
...
import org.measure.sonarqube.newlinecoverage.data.RTHistory;
import org.measure.sonarqube.newlinecoverage.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_line_coverage&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
