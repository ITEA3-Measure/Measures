package org.measure.sonarqube.branchcoverage.hitsdata;
...
import org.measure.sonarqube.branchcoverage.hitsdata.data.RTHistory;
import org.measure.sonarqube.branchcoverage.hitsdata.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=branch_coverage_hits_data&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
