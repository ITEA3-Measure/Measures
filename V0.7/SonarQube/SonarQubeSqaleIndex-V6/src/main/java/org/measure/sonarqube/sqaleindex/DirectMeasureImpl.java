package org.measure.sonarqube.sqaleindex;
...
import org.measure.sonarqube.sqaleindex.data.RTHistory;
import org.measure.sonarqube.sqaleindex.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=sqale_index&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
