package org.measure.sonarqube.newinfoviolations;
...
import org.measure.sonarqube.newinfoviolations.data.RTHistory;
import org.measure.sonarqube.newinfoviolations.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_info_violations&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
