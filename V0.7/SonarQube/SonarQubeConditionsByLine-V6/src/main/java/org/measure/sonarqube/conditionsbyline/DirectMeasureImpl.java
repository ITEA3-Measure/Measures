package org.measure.sonarqube.conditionsbyline;
...
import org.measure.sonarqube.conditionsbyline.data.RTHistory;
import org.measure.sonarqube.conditionsbyline.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=conditions_by_line&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
