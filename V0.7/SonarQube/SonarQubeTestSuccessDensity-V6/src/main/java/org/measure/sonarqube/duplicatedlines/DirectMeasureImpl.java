package org.measure.sonarqube.duplicatedlines;
...
import org.measure.sonarqube.duplicatedlines.data.RTHistory;
import org.measure.sonarqube.duplicatedlines.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=test_success_density&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
