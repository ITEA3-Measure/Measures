package org.measure.sonarqube.newbranchcoverage;
...
import org.measure.sonarqube.newbranchcoverage.data.RTHistory;
import org.measure.sonarqube.newbranchcoverage.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_branch_coverage&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
