package org.measure.sonarqube.falsepositiveissues;
...
import org.measure.sonarqube.falsepositiveissues.data.RTHistory;
import org.measure.sonarqube.falsepositiveissues.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=false_positive_issues&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
