package org.measure.sonarqube.newcodesmells;
...
import org.measure.sonarqube.newcodesmells.data.RTHistory;
import org.measure.sonarqube.newcodesmells.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_code_smells&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
