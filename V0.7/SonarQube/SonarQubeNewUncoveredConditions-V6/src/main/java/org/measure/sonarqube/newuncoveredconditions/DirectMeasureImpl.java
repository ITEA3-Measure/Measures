package org.measure.sonarqube.newuncoveredconditions;
...
import org.measure.sonarqube.newuncoveredconditions.data.RTHistory;
import org.measure.sonarqube.newuncoveredconditions.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_uncovered_conditions&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
