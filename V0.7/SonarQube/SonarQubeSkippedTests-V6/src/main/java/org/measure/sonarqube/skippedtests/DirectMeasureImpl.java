package org.measure.sonarqube.skippedtests;
...
import org.measure.sonarqube.skippedtests.data.RTHistory;
import org.measure.sonarqube.skippedtests.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=skipped_tests&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
