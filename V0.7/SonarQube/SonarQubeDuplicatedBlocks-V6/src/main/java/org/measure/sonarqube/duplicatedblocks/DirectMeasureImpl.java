package org.measure.sonarqube.duplicatedblocks;
...
import org.measure.sonarqube.duplicatedblocks.data.RTHistory;
import org.measure.sonarqube.duplicatedblocks.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=duplicated_blocks&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
