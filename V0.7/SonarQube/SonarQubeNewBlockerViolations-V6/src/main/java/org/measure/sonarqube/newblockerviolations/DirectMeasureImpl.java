package org.measure.sonarqube.newblockerviolations;
...
import org.measure.sonarqube.newblockerviolations.data.RTHistory;
import org.measure.sonarqube.newblockerviolations.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=new_blocker_violations&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
