package org.measure.sonarqube.linestocover;
...
import org.measure.sonarqube.linestocover.data.RTHistory;
import org.measure.sonarqube.linestocover.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=lines_to_cover&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
