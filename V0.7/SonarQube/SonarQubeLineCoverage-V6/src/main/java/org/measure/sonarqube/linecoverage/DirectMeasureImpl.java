package org.measure.sonarqube.linecoverage;
...
import org.measure.sonarqube.linecoverage.data.RTHistory;
import org.measure.sonarqube.linecoverage.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=line_coverage&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
