package org.measure.sonarqube.sqaledebtratio;
...
import org.measure.sonarqube.sqaledebtratio.data.RTHistory;
import org.measure.sonarqube.sqaledebtratio.data.RTMetric;
...
public class DirectMeasureImpl extends DirectMeasure {
    ...
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        RTMetric res = restTemplate.getForObject(sonarQubeURL + "/api/measures/search_history?metrics=sqale_debt_ratio&component=" + component + "&fromDateTime=" + SONAR_DATE_FORMAT.format(fromDate), RTMetric.class);
