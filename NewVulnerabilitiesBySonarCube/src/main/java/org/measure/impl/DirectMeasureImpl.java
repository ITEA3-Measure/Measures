...
@objid ("673f06f5-4cfb-49bd-830a-266e4e1743b2")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("201e38ba-a45e-4f62-b314-06e35a079a62")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_vulnerabilities"));
            Measure m = struts.getMeasure("new_vulnerabilities");
