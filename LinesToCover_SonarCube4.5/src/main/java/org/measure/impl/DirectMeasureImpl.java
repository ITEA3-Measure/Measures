...
@objid ("335c006b-9a7e-4580-831f-943a30d1390c")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("a44aff3b-8aff-4a5f-9fce-2c58bc2bc238")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "lines_to_cover"));
            Measure m = struts.getMeasure("lines_to_cover");
