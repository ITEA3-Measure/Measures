...
@objid ("129892ed-f9d5-439e-944c-08efebcd4a62")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("f4276b34-fb66-45be-a816-11b9fecea014")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "class_complexity"));
            Measure m = struts.getMeasure("class_complexity");
