...
@objid ("708490af-c383-4f01-9440-e5e295fd8c26")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("3639e8fe-844f-4c4d-8e05-69f1a1ba5f6d")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "reliability_rating"));
            Measure m = struts.getMeasure("reliability_rating");
