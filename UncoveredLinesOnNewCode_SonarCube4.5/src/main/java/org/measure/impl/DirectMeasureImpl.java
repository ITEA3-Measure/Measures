...
@objid ("d6e6ce8f-51ad-4cbe-879d-6a7a3741a71c")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("87bb57d0-4f89-4f10-9fee-d87a0debad9a")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_uncovered_lines"));
            Measure m = struts.getMeasure("new_uncovered_lines");
