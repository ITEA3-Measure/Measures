...
@objid ("488e7bfe-e2b1-4e39-aa8e-33eca283a315")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("d181ce7d-cb3f-4ecc-88ef-281208beaae0")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "duplicated_blocks"));
            Measure m = struts.getMeasure("duplicated_blocks");
