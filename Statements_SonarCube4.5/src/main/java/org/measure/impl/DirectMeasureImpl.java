...
@objid ("817c1fa7-e2a7-402c-99f6-9a3798a3cbef")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("d7eeb226-a92e-4ce9-b792-f23ebc0e9ec0")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "statements"));
            Measure m = struts.getMeasure("statements");
