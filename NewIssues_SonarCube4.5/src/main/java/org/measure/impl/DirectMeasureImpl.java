...
@objid ("8968cbf7-0000-47a2-9789-6c759f7cddae")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("e009e86c-a110-4322-922f-86e47c170938")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "new_violations"));
            Measure m = struts.getMeasure("new_violations");
