...
@objid ("bb393b34-98a9-4d75-9785-bb7689f338db")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("1926b2d9-ad97-4846-9ffb-de6eb1d97c4d")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "false_positive_issues"));
            Measure m = struts.getMeasure("false_positive_issues");
