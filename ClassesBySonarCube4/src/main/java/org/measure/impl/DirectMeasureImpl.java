...
@objid ("f22ee2e5-9b15-43d1-8f3b-a81cf54abec6")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("e91f8392-b52d-47f3-8dbf-baea3d9b4afa")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "classes"));
            Measure m = struts.getMeasure("classes");
