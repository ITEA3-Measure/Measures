...
@objid ("7c0b8f56-e0dc-4774-8a14-323a9f9eba3c")
public class DirectMeasureImpl extends DirectMeasure {
    @objid ("de86fae7-37f4-4d8b-ba25-4048bbb9ef39")
    @Override
    public List<IMeasurement> getMeasurement() throws Exception {
        ...
        try {
            ...
            Resource struts = sonar.find(ResourceQuery.createForMetrics(projectKey, "reopened_issues"));
            Measure m = struts.getMeasure("reopened_issues");
