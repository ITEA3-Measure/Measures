...
public class DirectMeasureImpl extends DirectMeasure {
	...
	protected void initProperties() {
		...
		this.query = "var  reqs = Requirement.all;" + "var sreq = 0;" + "for( req in reqs){"
				+ "if(req.SubRequirement.notEmpty()){" + "sreq = sreq + req.SubRequirement.size();" + "}" + "}"
				+ "if(reqs.notEmpty()){" + "	return sreq / reqs.size() * 100;" + "}" + "return 0;";
	}
